...
* __Text Editor__: [Neovim](https://neovim.io/) -> [gedit](https://wiki.gnome.org/Apps/Gedit) -> [Bluefish](https://sourceforge.net/projects/bluefish/) -> [JOE](https://joe-editor.sourceforge.io/) -> [nvi](https://repo.or.cz/nvi.git) -> [mousepad](https://gitlab.xfce.org/apps/mousepad) -> [Vim](https://www.vim.org/) -> [Elvis](https://github.com/mbert/elvis) -> [TEA](http://semiletov.org/tea/) -> [ne](https://ne.di.unimi.it/) -> [Nano](https://www.nano-editor.org/) -> [jove](https://github.com/jonmacs/jove) -> [GNU Zile](https://git.savannah.gnu.org/cgit/zile.git) -> [vis](https://github.com/martanne/vis) -> [ox](https://github.com/curlpipe/ox) -> [mle](https://github.com/adsr/mle) -> [mg](https://github.com/troglobit/mg) -> [ed](https://www.gnu.org/software/ed/)
